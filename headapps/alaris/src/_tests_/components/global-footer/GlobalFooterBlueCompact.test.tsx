...
import { GlobalFooterBlueCompact } from '@/components/global-footer/GlobalFooterBlueCompact.dev';
...
describe('GlobalFooterBlueCompact Component', () => {
  it('renders without crashing', () => {
    const { container } = render(<GlobalFooterBlueCompact {...mockGlobalFooterProps} />);
    expect(container).toBeInTheDocument();
    expect(container.querySelector('footer')).toBeInTheDocument();
  });

  it('displays all main sections with compact layout', () => {
    render(<GlobalFooterBlueCompact {...mockGlobalFooterProps} />);
  ...
  it('displays footer with compact blue styling', () => {
    render(<GlobalFooterBlueCompact {...mockGlobalFooterProps} />);
