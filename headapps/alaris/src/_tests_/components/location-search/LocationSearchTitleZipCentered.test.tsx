...
import { LocationSearchTitleZipCentered } from '@/components/location-search/LocationSearchTitleZipCentered.dev';
...
describe('LocationSearchTitleZipCentered', () => {
  beforeEach(() => {
  ...
  it('renders component with title', async () => {
    const { getByText } = render(<LocationSearchTitleZipCentered {...mockLocationSearchProps} />);
    await waitFor(() => {
  ...
  it('renders Google Map component', async () => {
    const { getByTestId } = render(<LocationSearchTitleZipCentered {...mockLocationSearchProps} />);
    await waitFor(() => {
  ...
  it('renders animated section wrapper', async () => {
    const { getAllByTestId } = render(
      <LocationSearchTitleZipCentered {...mockLocationSearchProps} />
    );
    await waitFor(() => {
