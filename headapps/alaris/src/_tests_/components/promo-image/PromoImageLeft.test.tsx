...
import { PromoImageLeft } from '@/components/promo-image/PromoImageLeft.dev';
...
describe('PromoImageLeft', () => {
  it('renders image left layout with vehicle content', () => {
    render(<PromoImageLeft {...mockPromoImageProps} />);
  ...
  it('renders image on the left side with correct attributes', () => {
    render(<PromoImageLeft {...mockPromoImageProps} />);
