...
export const heroVariants = cva('hero @container py-24 relative w-full overflow-hidden', {
  variants: {
    colorScheme: {
      ...
      secondary: 'bg-secondary text-heading',
      tertiary: 'bg-tertiary text-heading',
      dark: 'bg-dark text-primary-foreground',
      light: 'bg-light text-heading',
    },
  },
  defaultVariants: {
    colorScheme: 'light',
            ...
            >
              {(titleRequired?.value || isPageEditing) && (
                <Text
                  tag="h1"
                  field={titleRequired}
                  className="font-heading @lg:text-8xl @lg:leading-[90px] basis-1/2 text-5xl font-normal leading-[60px] text-inherit"
                />
              )}
            ...
            <div className="@lg:gap-8 @lg:min-w-[120%] mx-auto flex min-w-[110%]  items-start gap-4 px-4">
              <div className="shrink-0 grow-0 basis-1/4">
                <MediaSection
                  ...
                  className="aspect-280/356 relative shadow-[0_0_5px_0_rgba(0,0,0,0.1)]"
                  pause={!isPlaying}
              ...
              <div className="shrink-0 grow-0 basis-1/4">
                <MediaSection
                  ...
                  className="aspect-280/196 relative shadow-[0_0_5px_0_rgba(0,0,0,0.1)]"
                  pause={!isPlaying}
                  reducedMotion={isPageEditing || prefersReducedMotion}
                />
              </div>
