  ...
  'inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-full text-sm font-bold ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0',
  {
    variants: {
      variant: {
        ...
        outline:
          'border border-primary bg-background text-primary hover:bg-primary-hover hover:text-primary-foreground',
        secondary:
          'border border-primary bg-transparent text-primary hover:bg-primary-hover hover:text-primary-foreground',
        tertiary: 'bg-tertiary text-tertiary-foreground hover:bg-tertiary/80',
        ghost: 'hover:bg-accent hover:text-accent-foreground',
        link: 'text-brand-link underline-offset-4 hover:text-brand-navy hover:underline',
        topic:
        ...
        'rounded-white':
          'rounded-full bg-white text-heading hover:bg-surface-subtle transition-all duration-300',
      },
      size: {
        default: 'px-8 py-2-5',
