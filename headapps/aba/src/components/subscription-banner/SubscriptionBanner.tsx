...
export const Default: React.FC<SubscriptionBannerProps> = ({ fields }) => {
  ...
  return (
    <section className="bg-secondary/80 mx-auto w-full px-4 py-16 text-center">
      <div className="@container mx-auto max-w-5xl">
        {titleRequired && (
          <Text
            tag="h2"
            field={titleRequired}
            className="text-heading font-heading mb-6 font-normal leading-tight tracking-tight [font-size:clamp(theme(fontSize.3xl),5cqi,theme(fontSize.7xl))]"
          />
        )}
        {descriptionOptional && (
          <Text
            ...
            className="font-body text-muted-foreground mb-12 text-lg"
          />
        )}
        <Form {...form}>
          <form
