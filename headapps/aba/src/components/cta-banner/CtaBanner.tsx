...
const ctaButtonVariants = cva('text-sm font-heading font-bold', {
  variants: {
    colorScheme: {
        ...
        <div className="mx-auto w-full max-w-4xl">
          ...
          <AnimatedSection direction="up" isPageEditing={isPageEditing}>
            ...
            <Text
              tag="p"
              className={cn(
                'mx-auto mb-16 max-w-xl text-lg antialiased',
                !colorScheme && 'text-foreground',
                colorScheme === ColorScheme.PRIMARY && 'text-primary-foreground',
                colorScheme === ColorScheme.SECONDARY && 'text-secondary-foreground'
              )}
