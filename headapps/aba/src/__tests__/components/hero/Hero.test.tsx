...
describe('Hero Component', () => {
  ...
  describe('Color scheme variants', () => {
    it('should apply light color scheme classes', () => {
      ...
      const section = container.querySelector('section');
      expect(section).toHaveClass('bg-light', 'text-heading');
    });
    ...
    it('should apply secondary color scheme classes', () => {
      ...
      const section = container.querySelector('section');
      expect(section).toHaveClass('bg-secondary', 'text-heading');
    });
    ...
    it('should apply tertiary color scheme classes', () => {
      ...
      const section = container.querySelector('section');
      expect(section).toHaveClass('bg-tertiary', 'text-heading');
    });
    ...
    it('should apply dark color scheme classes', () => {
      ...
      const section = container.querySelector('section');
      expect(section).toHaveClass('bg-dark', 'text-primary-foreground');
    });
    ...
    it('should apply correct button classes for primary scheme', () => {
      ...
      expect(button).toHaveClass('text-primary', 'bg-background', 'hover:bg-secondary');
    });
  });
