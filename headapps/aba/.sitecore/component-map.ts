...
import * as pricingdetailsparams from 'src/components/pricing-details/pricing-details-params';
import * as pricingdetailscredit from 'src/components/pricing-details/pricing-details-credit';
...
export const componentMap = new Map<string, NextjsContentSdkComponent>([
  ...
  ['pricing-details-params', { ...pricingdetailsparams }],
  ['pricing-details-credit', { ...pricingdetailscredit }],
  ['PricingDetails', { ...PricingDetails, componentType: 'client' }],
  ['portal', { ...portaldev }],
  ['People', { ...People }],
