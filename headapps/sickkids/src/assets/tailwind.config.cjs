...
module.exports = {
    ...
    theme: {
        extend: {
            ...
            backgroundImage: {
                'light-gradient':
                    'linear-gradient(to bottom, #ffffff 0%, rgba(0, 151, 204, 0) 100%)',
                'primary-gradient':
                    'linear-gradient(179.89deg, #005a7a 0.1%, rgba(0, 151, 204, 0) 115.08%)',
                'dark-gradient': 'linear-gradient(to bottom, #e8eef2 0%, rgba(15, 40, 65, 0) 100%)',
                'img-primary':
