...
import { LocationSearchDefault } from '@/components/location-search/LocationSearchDefault.dev';
...
describe('LocationSearchDefault', () => {
  beforeEach(() => {
  ...
  it('renders component with title and dealerships', async () => {
    const { getByText } = render(<LocationSearchDefault {...mockLocationSearchProps} />);
    await waitFor(() => {
  ...
  it('renders Google Map component', async () => {
    const { getByTestId } = render(<LocationSearchDefault {...mockLocationSearchProps} />);
    await waitFor(() => {
  ...
  it('renders animated section wrapper', async () => {
    const { getAllByTestId } = render(<LocationSearchDefault {...mockLocationSearchProps} />);
    await waitFor(() => {
