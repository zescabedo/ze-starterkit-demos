...
import { PromoImageMiddle } from '@/components/promo-image/PromoImageMiddle.dev';
...
describe('PromoImageMiddle', () => {
  it('renders middle layout with centered content', () => {
    render(<PromoImageMiddle {...mockPromoImageProps} />);
  ...
  it('renders vehicle image as background', () => {
    render(<PromoImageMiddle {...mockPromoImageProps} />);
  ...
  it('renders button in centered position', () => {
    render(<PromoImageMiddle {...mockPromoImageProps} />);

    const button = screen.getByTestId('button');
    expect(button).toHaveTextContent('Explore Ambulance Fleet');
    expect(button).toHaveAttribute('data-href', '/vehicles/ambulances');
  });
});
