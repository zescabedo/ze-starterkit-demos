...
import { GlobalFooterDefault } from '@/components/global-footer/GlobalFooterDefault.dev';
...
describe('GlobalFooterDefault Component', () => {
  it('renders without crashing', () => {
    const { container } = render(<GlobalFooterDefault {...mockGlobalFooterProps} />);
    expect(container).toBeInTheDocument();
    expect(container.querySelector('footer')).toBeInTheDocument();
  });

  it('displays all main sections with correct content', () => {
    render(<GlobalFooterDefault {...mockGlobalFooterProps} />);
  ...
  it('displays footer with primary styling', () => {
    render(<GlobalFooterDefault {...mockGlobalFooterProps} />);
